-- Ejecutar si `prisma migrate deploy` no alcanza el servidor (I007/I012/I014).
-- Si columna/tabla/índice ya existen, omitir el statement correspondiente.
...
CREATE TABLE IF NOT EXISTS `tbl_feature_flag` (
...
CREATE TABLE IF NOT EXISTS `tbl_domain_event` (
