...
export const PERMISO = {
  ...
  REPORTE_CLIENTE_OBLIGACIONES_READ: 'REPORTE_CLIENTE_OBLIGACIONES_READ',
...
/** Finos de reportes por grupo (H28: adoptados en presets, no solo grupos). */
export const PERMISOS_REPORTE_FINOS_COBRANZA: PermisoCodigo[] = [
  PERMISO.REPORTE_HUB_READ,
  PERMISO.REPORTE_COBRANZA_KPI_READ,
  PERMISO.REPORTE_AGING_READ,
];
...
export const PERMISOS_REPORTE_FINOS_OPERACION: PermisoCodigo[] = [
  ...
  PERMISO.REPORTE_RECONTACTOS_READ,
];

export const PERMISOS_REPORTE_FINOS_RIESGO: PermisoCodigo[] = [
  PERMISO.REPORTE_CUMPLIMIENTO_ACUERDOS_READ,
  PERMISO.REPORTE_CARTERA_SIN_GESTION_READ,
  PERMISO.REPORTE_RECLAMOS_SLA_READ,
  PERMISO.REPORTE_MIGRACION_MORA_READ,
  PERMISO.REPORTE_CONCENTRACION_RIESGO_READ,
  PERMISO.REPORTE_CLIENTE_OBLIGACIONES_READ,
  PERMISO.REPORTE_CUOTAS_VENCIDAS_READ,
];

export const PERMISOS_REPORTE_FINOS_EQUIPO: PermisoCodigo[] = [
  PERMISO.REPORTE_CUMPLIMIENTO_METAS_READ,
  PERMISO.REPORTE_SUPERVISOR_EQUIPO_READ,
];

export const PERMISOS_REPORTE_FINOS_FINANZAS: PermisoCodigo[] = [
  PERMISO.REPORTE_GANANCIAS_READ,
  PERMISO.REPORTE_COMISIONES_COBRADORES_READ,
  PERMISO.REPORTE_MARGEN_MANDANTES_READ,
  PERMISO.REPORTE_COMISIONES_VS_PROYECCION_READ,
  PERMISO.REPORTE_INGRESO_TRAMO_MORA_READ,
];

export const PERMISOS_REPORTE_FINOS_GERENCIAL: PermisoCodigo[] = [
  PERMISO.REPORTE_INFORME_GERENCIAL_READ,
];
...
export const PERMISOS_COBRADOR: PermisoCodigo[] = [
  ...
  ...PERMISOS_REPORTE_FINOS_OPERACION,
];
...
export const PERMISOS_GERENTE: PermisoCodigo[] = [
  ...
  PERMISO.REPORTE_FINANZAS_READ,
  PERMISO.REPORTE_GERENCIAL_READ,
  ...PERMISOS_REPORTE_FINOS_FINANZAS,
